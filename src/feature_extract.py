...
data = pd.read_csv("data/preprocessed/student_depression_dataset_preprocessed.csv")
...
data.to_csv("data/model_ready/student_depression_dataset_model_ready.csv", index=False)
